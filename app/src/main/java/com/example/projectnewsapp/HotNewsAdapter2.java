...
public class HotNewsAdapter2 extends RecyclerView.Adapter<HotNewsAdapter2.ViewHolder> {
    private List<Model2> model2List;

    public HotNewsAdapter2(List<Model2> model2List) {
        this.model2List = model2List;
    }

    @NonNull
    @Override
    public HotNewsAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_headlines, parent, false);
        return new HotNewsAdapter2.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HotNewsAdapter2.ViewHolder holder, int position) {
        ...
        private void setHeadline(String hLine) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(), DetailsActivity2.class);
