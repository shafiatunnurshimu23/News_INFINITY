...
public class DetailsActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailsTitle = findViewById(R.id.detailsTitle2);
        detailsPublishedBy = findViewById(R.id.detailsPublishedBy2);
        detailsPublishTime = findViewById(R.id.detailsPublishTime2);
        detailsDescription = findViewById(R.id.detailsDescription2);
        detailsImage = findViewById(R.id.detailsImage2);
        ...
        firebaseFirestore.collection("CountryWiseNews").orderBy("index").get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                                ...
                                for (long i = 1; i <= noOfNews; i++) {
                                    ...
                                    if (getTitle.equals(title)) {
                                        ...
                                        Glide.with(DetailsActivity2.this).load(image).apply(new RequestOptions()).placeholder(R.drawable.news).into(detailsImage);
                            ...
                            Toast.makeText(DetailsActivity2.this, error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        /// back button
